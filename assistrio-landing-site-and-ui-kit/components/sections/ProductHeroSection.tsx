...
export default function ProductHeroSection({ className = '' }: ProductHeroSectionProps) {
    return (
        <Section className={`bg-gradient-to-br from-brand-50 via-white to-brand-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden ${className}`}>
            ...
            <div className="relative text-center">
                ...
                >
                    ...
                    >
                        Discover how <Alexi />, Assistrio&apos;s intelligent Customer Success bot, transforms your customer support with AI-powered automation.
                    </motion.div>
                </motion.div>
            </div>
        </Section>
